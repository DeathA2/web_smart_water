...
class LoadingScreen extends StatefulWidget {
  ...
  const LoadingScreen(
      {Key? key, this.height, this.width, this.primaryColor, this.secondColor})
      : super(key: key);
          ...
          child: Center(
            child: Stack(
              children: [
                Transform.translate(
                  offset: Offset(
                      (radius / 2) * cos(pi / 2), (radius / 2) * sin(-pi / 2)),
                  child: ScaleTransition(
                    scale: _animation1,
                    child: Container(
                      decoration: BoxDecoration(
                          color:
                              widget.primaryColor ?? ThemeConfig.primaryColor,
                ...
                Transform.translate(
                  offset:
                      Offset((radius / 2) * cos(pi), (radius / 2) * sin(pi)),
                  child: ScaleTransition(
                    scale: _animation2,
                    child: Container(
                      decoration: BoxDecoration(
